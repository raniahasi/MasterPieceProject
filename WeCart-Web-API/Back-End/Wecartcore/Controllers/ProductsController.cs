    ...
    public class ProductsController : ControllerBase
    {
        ...
        public IActionResult AddProduct([FromForm] ProductDTO productDto)
        {
            ...
            var product = new Product
            {
                ...
                ProductColorId = productDto.ProductColorId, // Make sure this line is added
        ...
        public IActionResult UpdateProduct(int id, [FromForm] ProductDTO productDto)
        {
            ...
            product.ProductColorId = int.TryParse(productDto.Color, out int ProductColorId) ? ProductColorId : (int?)null; // Assuming color is passed as ID
        ...
        {
            var products = _context.Products.Where(p => p.ProductColorId == colorId).ToList();
            return Ok(products);
        }
